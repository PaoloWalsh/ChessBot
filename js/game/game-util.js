/**
 * @brief stampa il board, funzione per debug
 */
function printBoard() {
...
function getPiece(id) {
    let piece;
    let index = parseInt(id.slice(-1)); // prende l'ultimo carattere dell'id
    switch (id) {
        case "white_king":
            piece = white_king;
            return piece;
    ...
    id = id.slice(0, -1);   // tutti i pezzi in singola istanza (i re) sono stati considerati,
    //tolgo il numero del pezzo dall'id
    switch (id) {
        case "white_pawn":
